...
namespace HealthCare.Controllers
{
    ...
    public class PatientPregnancyController : ControllerBase
    {
        ...
        public PatientPregnancyController(HealthCareContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Get([FromQuery] string filters)
        {
            ...
            var result = FilterService<PatientPregnancy>.ApplyFilter(query, filterCriteria);
            return Ok(result);
        }

        /// <summary>Retrieves a specific patientpregnancy by its primary key</summary>
        /// <param name="entityId">The primary key of the patientpregnancy</param>
