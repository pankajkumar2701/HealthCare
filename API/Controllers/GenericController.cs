...
namespace HealthCare.Controllers
{
    ...
    public class GenericController : ControllerBase
    {
        ...
        public GenericController(HealthCareContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Get([FromQuery] string filters)
        {
            ...
            var result = FilterService<Generic>.ApplyFilter(query, filterCriteria);
            return Ok(result);
        }

        /// <summary>Retrieves a specific generic by its primary key</summary>
        /// <param name="entityId">The primary key of the generic</param>
