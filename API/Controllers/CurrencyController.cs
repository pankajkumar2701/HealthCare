...
namespace HealthCare.Controllers
{
    ...
    public class CurrencyController : ControllerBase
    {
        ...
        public CurrencyController(HealthCareContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Get([FromQuery] string filters)
        {
            ...
            var result = FilterService<Currency>.ApplyFilter(query, filterCriteria);
            return Ok(result);
        }

        /// <summary>Retrieves a specific currency by its primary key</summary>
        /// <param name="entityId">The primary key of the currency</param>
