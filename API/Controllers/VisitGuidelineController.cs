...
namespace HealthCare.Controllers
{
    ...
    public class VisitGuidelineController : ControllerBase
    {
        ...
        public VisitGuidelineController(HealthCareContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Get([FromQuery] string filters)
        {
            ...
            var result = FilterService<VisitGuideline>.ApplyFilter(query, filterCriteria);
            return Ok(result);
        }

        /// <summary>Retrieves a specific visitguideline by its primary key</summary>
        /// <param name="entityId">The primary key of the visitguideline</param>
