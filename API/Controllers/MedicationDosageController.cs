...
namespace HealthCare.Controllers
{
    ...
    public class MedicationDosageController : ControllerBase
    {
        ...
        public MedicationDosageController(HealthCareContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Get([FromQuery] string filters)
        {
            ...
            var result = FilterService<MedicationDosage>.ApplyFilter(query, filterCriteria);
            return Ok(result);
        }

        /// <summary>Retrieves a specific medicationdosage by its primary key</summary>
        /// <param name="entityId">The primary key of the medicationdosage</param>
